...
export const mockOptionGroups: OptionGroup[] = [
    ...
    },
    {
        ...
        type: 'exclusion',
        options: [
            { id: 'O12', name: 'Onions', priceAdjustment: 0 },
            { id: 'O13', name: 'Pickles', priceAdjustment: 0 },
            { id: 'O14', name: 'Lettuce', priceAdjustment: 0 },
        ]
    }
];

export const mockMenuItems: MenuItem[] = [
    { id: 'M01', productType: 'single', name: 'Classic Burger', category: 'Main Course', price: 12.99, description: 'A juicy beef patty with all the fixings.', isActive: true, optionGroups: [mockOptionGroups[1], mockOptionGroups[3]], crossSellGroups: [{ id: 'csg-1', name: 'Goes great with', productIds: ['M06'] }], allowNotes: true },
    { id: 'M02', productType: 'single', name: 'Caesar Salad', category: 'Appetizers', price: 8.99, description: 'Crisp romaine with creamy Caesar dressing.', isActive: true, optionGroups: [], allowNotes: true },
    { id: 'M03', productType: 'single', name: 'Chocolate Lava Cake', category: 'Desserts', price: 7.50, description: 'Warm chocolate cake with a molten center.', isActive: true, optionGroups: [], allowNotes: false },
    { id: 'M04', productType: 'single', name: 'Spaghetti Carbonara', category: 'Main Course', price: 15.50, description: 'Classic pasta with pancetta and egg.', isActive: false, optionGroups: [], allowNotes: true },
    { id: 'M05', productType: 'single', name: 'Iced Coffee', category: 'Drinks', price: 4.50, description: 'Chilled coffee over ice.', isActive: true, optionGroups: [mockOptionGroups[0], mockOptionGroups[2]], allowNotes: false },
    { id: 'M06', productType: 'single', name: 'Fries', category: 'Appetizers', price: 4.50, description: 'Crispy golden fries.', isActive: true, optionGroups: [], allowNotes: true },
